...
namespace glava16
{
    public partial class Form1 : Form
    {
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            myWebClient.DownloadFile(myStringWebResource, "C:\\Users\\Xiaomi\\" + fileName);
        ...
        private void FTPUploadFile(string filename)
        {
            ...
            reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri("ftp://" + "ftp.narod.ru" + "/" + fileInfo.Name));
            ...
            {
                listBox1.Items.Add("Ошибка при закачке файла");
            }
        ...
        {
            FTPDownloadFile("C:\\Users\\Xiaomi", "ruspro.gif");
        }
